package me.outspending.biomesapi.wrapper.environment.particles;

import me.outspending.biomesapi.annotations.AsOf;
import me.outspending.biomesapi.wrapper.environment.particles.options.BlockParticle;
import me.outspending.biomesapi.wrapper.environment.particles.options.ColorParticle;
import me.outspending.biomesapi.wrapper.environment.particles.options.DustParticle;
import me.outspending.biomesapi.wrapper.environment.particles.options.DustTransitionParticle;
import me.outspending.biomesapi.wrapper.environment.particles.options.ItemParticle;
import me.outspending.biomesapi.wrapper.environment.particles.options.PowerParticle;
import me.outspending.biomesapi.wrapper.environment.particles.options.SculkChargeParticle;
import me.outspending.biomesapi.wrapper.environment.particles.options.SpellParticle;
import me.outspending.biomesapi.wrapper.environment.particles.options.TrailParticle;
import me.outspending.biomesapi.wrapper.environment.particles.options.VibrationParticle;
...
public enum WrappedParticleTypes {
    ...
    /**
     * Converts an AmbientParticle to its corresponding WrappedParticleTypes.
     * @param ambientParticle The AmbientParticle to convert.
     * @return The corresponding WrappedParticleTypes.
     */
    @AsOf("1.1.0")
    @SuppressWarnings("removal")
    @Deprecated(since = "1.1.0", forRemoval = true)
    public static WrappedParticleTypes fromAmbientParticle(me.outspending.biomesapi.wrapper.environment.AmbientParticle ambientParticle) {
        return WrappedParticleTypes.valueOf(ambientParticle.name());
    }
