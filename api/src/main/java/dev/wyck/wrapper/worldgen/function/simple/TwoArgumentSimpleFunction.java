...
public interface TwoArgumentSimpleFunction extends SimpleFunction, Registerable<TwoArgumentSimpleFunction> { // misleading name?: vanilla does not extend SimpleFunction
    ...
    @ApiStatus.Internal
    ConstructWireProvider<TwoArgumentSimpleFunction> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.function.simple.TwoArgumentSimpleFunctionImpl");
