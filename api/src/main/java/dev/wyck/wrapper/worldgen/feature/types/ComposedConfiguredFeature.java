...
public interface ComposedConfiguredFeature extends ConfiguredFeature, Registerable<ComposedConfiguredFeature> {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<ComposedConfiguredFeature> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.feature.types.ComposedConfiguredFeatureImpl");
