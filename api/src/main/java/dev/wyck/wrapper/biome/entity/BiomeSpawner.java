...
import dev.wyck.wrapper.biome.entity.data.NaturalSpawner;
...
public interface BiomeSpawner extends Wrapper {
    ...
    @ApiStatus.Internal
    WireProvider<Factory> WIRE = WireProvider.create("dev.wyck.wrapper.biome.entity.BiomeSpawnerFactoryImpl");
