...
public interface NoiseThresholdConditionSource extends ConditionSource {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<NoiseThresholdConditionSource> WIRE = ConstructWireProvider.create("dev.wyck.*?.wrapper.worldgen.surface.condition.NoiseThresholdConditionSourceImpl");
