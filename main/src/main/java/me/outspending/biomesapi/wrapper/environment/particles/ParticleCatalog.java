...
public record ParticleCatalog(List<WrappedAmbientParticle<?>> particles) {
    ...
    /**
     * Creates a ParticleCatalog from a ParticleRenderer.
     * @param renderer The particle renderer.
     * @return A ParticleCatalog containing the particles from the renderer.
     */
