...
import static me.outspending.biomesapi.renderer.packet.handlers.NativeMinecraftPacketHandlerHelper.CHUNK_SECTIONS;
import static me.outspending.biomesapi.renderer.packet.handlers.NativeMinecraftPacketHandlerHelper.CHUNK_SECTION_SIZE;
...
public class PacketEventsPacketHandler implements PacketHandler {
    ...
    private static class MapChunkPacketListener implements PacketListener {
        ...
        public void onPacketSend(PacketSendEvent event) {
            ...
            var element = elementRegistry.getByName(new ResourceLocation(biomeResourceKey.resourceLocation().getNamespace(), biomeResourceKey.resourceLocation().getPath()));
