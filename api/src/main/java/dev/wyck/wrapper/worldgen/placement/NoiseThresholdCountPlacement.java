...
public interface NoiseThresholdCountPlacement extends PlacementModifier {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<NoiseThresholdCountPlacement> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.placement.NoiseThresholdCountPlacementImpl");
