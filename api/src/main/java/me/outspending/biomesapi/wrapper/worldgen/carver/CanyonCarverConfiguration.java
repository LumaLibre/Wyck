...
public record CanyonCarverConfiguration(
    ...
    @ApiStatus.Internal
    private static final WireProvider<Factory> WIRE = WireProvider.create("me.outspending.biomesapi.wrapper.worldgen.carver.CanyonCarverConfigurationFactoryImpl");

    @ApiStatus.Internal
    protected interface Factory extends NmsDecoder<CanyonCarverConfiguration> {
    ...
    @AsOf("2.4.0")
    static CanyonCarverConfiguration fromMinecraft(Object nms) {
