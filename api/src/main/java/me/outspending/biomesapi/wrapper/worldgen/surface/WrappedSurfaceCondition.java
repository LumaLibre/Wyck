 ...
 * gate where a {@link WrappedSurfaceRule} applies.
 *
 * @version 2.4.0
 * @since 2.4.0
 * @author Jsinco
...
public sealed interface WrappedSurfaceCondition extends NmsHandle permits WrappedSurfaceCondition.StoneDepth, WrappedSurfaceCondition.Not, WrappedSurfaceCondition.Water, WrappedSurfaceCondition.Biome, WrappedSurfaceCondition.Noise, WrappedSurfaceCondition.YCheck, WrappedSurfaceCondition.VerticalGradient, WrappedSurfaceCondition.Steep, WrappedSurfaceCondition.Hole, WrappedSurfaceCondition.AbovePreliminarySurface, WrappedSurfaceCondition.Temperature {

    @ApiStatus.Internal
    WireProvider<Factory> WIRE = WireProvider.create("me.outspending.biomesapi.*.wrapper.worldgen.surface.WrappedSurfaceConditionFactoryImpl");

    @ApiStatus.Internal
    interface Factory {
        Object toNms(WrappedSurfaceCondition condition);
    }
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition stoneDepth(int offset, boolean addSurfaceDepth, CaveSurface surfaceType) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition stoneDepth(int offset, boolean addSurfaceDepth, int secondaryDepthRange, CaveSurface surfaceType) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition not(WrappedSurfaceCondition target) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition waterBlockCheck(int offset, int surfaceDepthMultiplier) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition waterStartCheck(int offset, int surfaceDepthMultiplier) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition isBiome(List<ResourceKey> biomes) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition noiseCondition(ResourceKey noise, double minThreshold) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition noiseCondition(ResourceKey noise, double minThreshold, double maxThreshold) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition yBlockCheck(VerticalAnchor anchor, int surfaceDepthMultiplier) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition yStartCheck(VerticalAnchor anchor, int surfaceDepthMultiplier) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition verticalGradient(String randomName, VerticalAnchor trueAtAndBelow, VerticalAnchor falseAtAndAbove) {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition steep() {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition hole() {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition abovePreliminarySurface() {
     ...
     */
    @AsOf("2.4.0")
    static WrappedSurfaceCondition temperature() {
        return Temperature.INSTANCE;
    }

    @AsOf("2.4.0")
    record StoneDepth(int offset, boolean addSurfaceDepth, int secondaryDepthRange, CaveSurface surfaceType) implements WrappedSurfaceCondition {}

    @AsOf("2.4.0")
    record Not(WrappedSurfaceCondition target) implements WrappedSurfaceCondition {}

    @AsOf("2.4.0")
    record Water(int offset, int surfaceDepthMultiplier, boolean addStoneDepth) implements WrappedSurfaceCondition {}

    @AsOf("2.4.0")
    record Biome(List<ResourceKey> biomes) implements WrappedSurfaceCondition {}

    @AsOf("2.4.0")
    record Noise(ResourceKey noise, double minThreshold, double maxThreshold) implements WrappedSurfaceCondition {}

    @AsOf("2.4.0")
    record YCheck(VerticalAnchor anchor, int surfaceDepthMultiplier, boolean addStoneDepth) implements WrappedSurfaceCondition {}

    @AsOf("2.4.0")
    record VerticalGradient(String randomName, VerticalAnchor trueAtAndBelow, VerticalAnchor falseAtAndAbove) implements WrappedSurfaceCondition {}

    @AsOf("2.4.0")
    record Steep() implements WrappedSurfaceCondition {
        static final Steep INSTANCE = new Steep();
    }

    @AsOf("2.4.0")
    record Hole() implements WrappedSurfaceCondition {
        static final Hole INSTANCE = new Hole();
    }

    @AsOf("2.4.0")
    record AbovePreliminarySurface() implements WrappedSurfaceCondition {
        static final AbovePreliminarySurface INSTANCE = new AbovePreliminarySurface();
    }

    @AsOf("2.4.0")
    record Temperature() implements WrappedSurfaceCondition {
