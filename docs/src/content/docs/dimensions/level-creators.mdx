...
<SourceLink path="model/level/LevelCreator.java">LevelCreator</SourceLink>s are Wyck's in-house implementation of Bukkit's [`WorldCreator`](https://jd.papermc.io/paper/26.2/org/bukkit/WorldCreator.html)
