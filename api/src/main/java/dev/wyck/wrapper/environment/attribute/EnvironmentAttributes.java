...
public final class EnvironmentAttributes {
    ...
    @AsOf("1.1.0")
    public static final EnvironmentAttributeSupplier<AmbientParticle> DEFAULT_DRIPSTONE_PARTICLE = supplierWith("visual/default_dripstone_particle", AmbientParticle::toMinecraft);
