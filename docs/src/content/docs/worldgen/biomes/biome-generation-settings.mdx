...
<SourceLink path="biome/BiomeGenerationSettings.java">BiomeGenerationSettings</SourceLink> is what binds
[`carvers`](/worldgen/carvers) and [`placed features`](/worldgen/placed-features) to a biome.

## Generation Steps

Placed features are added under a <SourceLink path="worldgen/Decoration.java">Decoration</SourceLink>,
