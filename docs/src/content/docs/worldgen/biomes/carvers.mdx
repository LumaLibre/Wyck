...
<CodeBlock
    ...
    code={`import dev.wyck.wrapper.worldgen.BiomeGenerationSettings;
    ...
    examples={[
        {
            ...
            filename: "ExamplePlugin.java",
            lang: "java",
            code: `import dev.wyck.wrapper.worldgen.carver.CaveCarverConfiguration;
...
ConfiguredWorldCarver cave = ConfiguredWorldCarver.cave(
    CaveCarverConfiguration.builder()
        ...
        },
        {
            ...
            filename: "ExamplePlugin.java",
            lang: "java",
            code: `import dev.wyck.wrapper.worldgen.carver.CanyonCarverConfiguration;
