...
@NullMarked
@AsOf("2.3.0")
public sealed interface VerticalAnchor extends Wrapper permits VerticalAnchor.Absolute, VerticalAnchor.AboveBottom, VerticalAnchor.BelowTop {

    @ApiStatus.Internal
    WireProvider<Factory> WIRE = WireProvider.create("dev.wyck.wrapper.worldgen.valueproviders.VerticalAnchorFactoryImpl");
