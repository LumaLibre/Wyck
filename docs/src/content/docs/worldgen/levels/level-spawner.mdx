...
<SourceLink path="level/entity/LevelSpawner.java">LevelSpawner</SourceLink>s are used to control
...
In Wyck, you can reference existing built-in <SourceLink path="level/entity/LevelSpawner.java">LevelSpawner</SourceLink>s
or author your own.

## SpawnTick (For Custom Spawners)

A <SourceLink path="level/entity/SpawnTick.java">SpawnTick</SourceLink> is a single tick of spawning for a given
