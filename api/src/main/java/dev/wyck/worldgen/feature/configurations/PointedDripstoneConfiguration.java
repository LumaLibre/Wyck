...
public interface PointedDripstoneConfiguration extends FeatureConfiguration {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<PointedDripstoneConfiguration> WIRE = ConstructWireProvider.create("dev.wyck.*?.worldgen.feature.config.PointedDripstoneConfigurationImpl");
