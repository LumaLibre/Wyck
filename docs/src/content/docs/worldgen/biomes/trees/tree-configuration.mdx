...
- `Trunk Provider` - The block state used for the trunk.
- [`Trunk Placer`](worldgen/biomes/trees/trunk-placers) - The configuration for the trunk of the tree.
- `Foliage Provider` - The block state used for foliage.
...
- `Ignore Vines` - A flag telling world generation if this tree should grow through vines or not.
- `Below Trunk Provider` - The block state used for the block(s) below the trunk of the tree.
