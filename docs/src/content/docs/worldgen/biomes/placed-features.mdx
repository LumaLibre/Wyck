...
A <SourceLink path="worldgen/placement/PlacedFeature.java" line={24}>PlacedFeature</SourceLink> is a
...
The <SourceLink path="worldgen/placement/PlacedFeatures.java">PlacedFeatures</SourceLink> catalog holds typed
...
* <SourceLink path="worldgen/placement/PlacementModifier.java" line={156}>`count(n)`</SourceLink> / `count(IntProvider)`: generate the feature a fixed or variable number of times per chunk.
