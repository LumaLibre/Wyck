...
import me.outspending.biomesapi.wrapper.environment.particle.NmsParticleOptionsHandle;
import me.outspending.biomesapi.wrapper.environment.particle.NmsParticleTypeHandle;
...
public final class NmsParticleOptionsFactory implements ParticleOptionsFactory {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public <T> ParticleTypeHandle<T> typeByKey(String key) {
        ...
        return (ParticleTypeHandle<T>) wrap(nms);
    }
