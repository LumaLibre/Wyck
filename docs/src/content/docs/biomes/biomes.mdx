...
<SourceLink path="biome/Biome.java">Biome</SourceLink>s
...
In addition to the basic <SourceLink path="biome/Biome.java">Biome</SourceLink> interface,
Wyck also provides a friendly <SourceLink path="biome/CustomBiome.java">CustomBiome</SourceLink>
