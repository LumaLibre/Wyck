...
public interface SpeleothemConfiguration extends FeatureConfiguration {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<SpeleothemConfiguration> WIRE = ConstructWireProvider.create("dev.wyck.*?.wrapper.worldgen.feature.configurations.SpeleothemConfigurationImpl");
