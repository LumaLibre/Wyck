...
public interface SurfaceRelativeThresholdFilter extends PlacementFilter {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<SurfaceRelativeThresholdFilter> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.placement.SurfaceRelativeThresholdFilterImpl");
