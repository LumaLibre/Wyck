...
public interface AmbientMoodSettings extends NmsHandle {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<AmbientMoodSettings> WIRE = ConstructWireProvider.create("me.outspending.biomesapi.wrapper.environment.sounds.AmbientMoodSettingsImpl");
