package dev.wyck.wrapper.worldgen.feature.configurations.end;
...
public interface EndSpike extends Wrapper {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<EndSpike> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.feature.configurations.end.EndSpikeImpl");
