...
A <SourceLink path="worldgen/carver/ConfiguredWorldCarver.java">ConfiguredWorldCarver</SourceLink> is either a
...
The <SourceLink path="worldgen/carver/Carvers.java">Carvers</SourceLink> catalog holds typed references to every
vanilla carver.

<CodeBlock
    lang="java"
    filename="ExamplePlugin.java"
    code={`import dev.wyck.biome.BiomeGenerationSettings;
...
ConfiguredWorldCarver cave = ConfiguredWorldCarver.cave(
    CaveCarverConfiguration.builder()
        ...
        .replaceable(Material.STONE, Material.DEEPSLATE)
...
import dev.wyck.worldgen.carver.CanyonCarverConfiguration.CanyonShapeConfiguration;
import dev.wyck.worldgen.carver.ConfiguredWorldCarver;
import dev.wyck.worldgen.valueproviders.FloatProvider;
import dev.wyck.worldgen.heightproviders.HeightProvider;
import dev.wyck.worldgen.heightproviders.VerticalAnchor;
