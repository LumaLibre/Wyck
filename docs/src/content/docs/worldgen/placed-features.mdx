...
description: Learn how to reference and author placed features with BiomesAPI, controlling where and how often features generate.
sidebar:
    order: 4
---
...
<CodeBlock
    ...
    code={`import me.outspending.biomesapi.wrapper.worldgen.placement.PlacedFeature;
...
<CodeBlock
    lang="java"
    filename="ExamplePlugin.java"
    code={`import me.outspending.biomesapi.wrapper.worldgen.HeightmapType;
