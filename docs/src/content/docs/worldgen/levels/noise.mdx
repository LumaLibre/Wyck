...
import dev.wyck.level.noise.Noise;
...
<CodeBlock
    ...
    code={
`import dev.wyck.level.noise.NoiseRouter;
import dev.wyck.level.noise.Noise;
import dev.wyck.level.noise.function.DensityFunction;
import dev.wyck.level.noise.function.DensityFunctions;
import dev.wyck.level.noise.settings.NoiseSettings;
import dev.wyck.worldgen.surface.SurfaceCondition;
