...
<SourceLink path="biome/entity/BiomeSpawner.java">BiomeSpawner</SourceLink>s modify server-sided behavior and must be physically set in the world.
This means that this API is not compatible with [`PacketHandlers`](/renderers/packet-handler/).

:::

Wyck provides a built-in system for customizing mob spawns inside custom biomes. <SourceLink path="biome/entity/BiomeSpawner.java">BiomeSpawner</SourceLink>s
...
Setting <SourceLink path="biome/entity/data/SpawnCost.java" line={13}>charge</SourceLink> **lower** and <SourceLink path="biome/entity/data/SpawnCost.java" line={13}>energyBudget</SourceLink> **higher** allows more of a specific mob to spawn concurrently.
