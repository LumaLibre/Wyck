...
is a wrapper for <SourceLink path="biome/Biome.java">Biome</SourceLink>s that is required for using the <SourceLink path="renderer/packet/PacketHandler.java">PacketHandler</SourceLink> interface.
