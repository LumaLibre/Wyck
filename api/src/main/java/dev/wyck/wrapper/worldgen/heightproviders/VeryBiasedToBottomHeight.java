...
public interface VeryBiasedToBottomHeight extends HeightProvider {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<VeryBiasedToBottomHeight> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.heightproviders.VeryBiasedToBottomHeightImpl");
