...
public final class WrappedEnvironmentAttributes {
    ...
    @ApiStatus.Internal
    private static @Nullable Map<String, WrappedEnvironmentAttributeSupplier<?, ?>> BY_ID;
    @ApiStatus.Internal
    private static volatile @Nullable Map<String, WrappedEnvironmentAttributeSupplier<?, ?>> BY_NAME;
