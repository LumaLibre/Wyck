...
public interface AbovePreliminarySurfaceConditionSource extends ConditionSource {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<AbovePreliminarySurfaceConditionSource> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.surface.condition.AbovePreliminarySurfaceConditionSourceImpl");
