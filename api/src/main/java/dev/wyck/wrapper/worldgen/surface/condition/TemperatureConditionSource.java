...
public interface TemperatureConditionSource extends ConditionSource {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<TemperatureConditionSource> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.surface.condition.TemperatureConditionSourceImpl");
