---
title: Adding Biomes to Dimensions
description: Learn how to inject or add your own biomes into dimension.
---
...
If you want use your world generation in an existing world such as `minecraft:overworld`, then this is a necessary step.

The <SourceLink path="registry/dimension/DimensionEditor.java">DimensionEditor</SourceLink> and the
...
The <SourceLink path="registry/dimension/DimensionEditor.java">DimensionEditor</SourceLink>, in its current state,
