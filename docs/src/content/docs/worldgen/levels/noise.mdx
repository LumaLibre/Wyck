...
<SourceLink path="worldgen/noise/Noise.java">Noise</SourceLink> is what a <SourceLink path="worldgen/chunk/ChunkGenerator.java">ChunkGenerator</SourceLink>
uses to shape terrain. Wyck provides ways to reference existing noise generators or author your own using
<SourceLink path="worldgen/noise/types/NoiseGeneratorSettings.java">NoiseGeneratorSettings</SourceLink>.
...
An authored <SourceLink path="worldgen/noise/types/NoiseGeneratorSettings.java">NoiseGeneratorSettings</SourceLink> is itself an instance of <SourceLink path="worldgen/noise/Noise.java">Noise</SourceLink>, so you can hand it straight to a generator
...
public class ExamplePlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        SurfaceRule surfaceRule = SurfaceRule.sequence(List.of(
            SurfaceRule.ifTrue(
                SurfaceRule.stoneDepth(0, false, CaveSurface.FLOOR),
...
A custom <SourceLink path="worldgen/noise/Noise.java">Noise</SourceLink>
