...
@NullMarked
@ApiStatus.Internal
public record ReplaceBlockConfigurationImpl(
    @Override List<OreConfiguration.TargetBlockState> targetStates
) implements ReplaceBlockConfiguration {
    @Override
    public Object toMinecraft() {
        ...
        return new net.minecraft.world.level.levelgen.feature.configurations.ReplaceBlockConfiguration(targets);
    }
}