...
public interface RandomizedIntStateProvider extends BlockStateProvider {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<RandomizedIntStateProvider> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.stateproviders.RandomizedIntStateProviderImpl");
