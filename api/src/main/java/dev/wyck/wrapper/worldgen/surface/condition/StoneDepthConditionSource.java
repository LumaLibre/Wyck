...
public interface StoneDepthConditionSource extends ConditionSource {
    ...
    @ApiStatus.Internal
    ConstructWireProvider<StoneDepthConditionSource> WIRE = ConstructWireProvider.create("dev.wyck.wrapper.worldgen.surface.condition.StoneDepthConditionSourceImpl");
